...
<div class="row">
    <div class="col-sm-12">
        ...
        <table id="tablaTipoTerapiaLoad" class="table">
            <!-- <br><h2>Mantenimiento de Parámetros</h2> -->
            <?php if (!$ocultarInsercion): ?>
            <button class="btn btn-primary btn-agregar" data-toggle="modal" data-target="#modalNuevaTerapia">
                <i class="fa-solid fa-plus"></i> Agregar Terapia</button>
            <?php endif; ?>
            ...
            <tbody>
                <?php
                $sql = "SELECT Id_Tipo_Tratamiento, Nombre FROM `tbl_tipo_tratamiento`";
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-warning" data-toggle="modal" title="Editar Tratamiento" data-target="#modalEditarTerapia" onclick="cargarDatos('<?php echo $datos; ?>')">
                                <i class="fa-solid fa-pen-to-square"></i></button>
                                <?php endif; ?>
                                <?php if (!$ocultarEliminacion): ?>
                            <button class="btn btn-danger" title="Eliminar Tratamiento" onclick="validarSiNo('<?php echo $filas[0]; ?>')"><i class="fa-solid fa-trash-can"></i></button>
                            <?php endif; ?>
                            <!-- <a href="./V_modal_tratamiento.php">
                                <button class="btn btn-primary btn-agregar" data-toggle="modal" data-target="#modalNuevaTerapia" style="margin-top: 1px; width:30%;">
...
<script>
    ...
    $(document).ready(function() {
        $('#tablaTipoTerapiaLoad').DataTable({
            language: {
                ...
                },
                {
                    ...
                    orientation: 'portrait',                   
                     customize: function(doc) {
                        ...
                        var title = 'Reporte de Tipos de Terapia';

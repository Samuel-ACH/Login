...
<body>
    ...
    <div class="pagetitle">
    <h1>Permisos por Rol <?php echo isset($fila['Id_Rol']) ? $fila['Id_Rol'] : ''; ?></h1>
    </div>
    <br>
    <div class="container mt-4">
        <div class="row">
            <div class="col-10">
            <button type="button" class="btn btn-primary" id="activarpermisosBtn">Activar permisos</button>
    ...
    <td><input type="checkbox" name="consultar" id="consultar" <?php echo $fila['Permiso_Consultar'] == 1 ? 'checked' : ''; ?> disabled></td>
...
<script>
    document.getElementById("activarpermisosBtn").onclick = function() {
        // Obtener todos los checkboxes de la tabla
        var checkboxes = document.querySelectorAll('#tablaAgenda input[type="checkbox"]');
        
        // Iterar sobre cada checkbox y quitar el atributo disabled

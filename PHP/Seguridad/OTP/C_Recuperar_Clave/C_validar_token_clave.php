...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['codigo_otp2'])) {
    ...
    if ($codigo_otp_ingresado2 == $codigo_otp_correcto2) {
        ...
        header("location: ../V_Recuperar_Clave/C_cambiar_clave.php"); // Redirigir al usuario a recuperar la contraseña
        exit();
    } else {
        ...
        header("location: ../V_Recuperar_Clave/C_verificar_token.php"); // Redirigir a la página de verificación de pin
        exit();
    }
}
?>

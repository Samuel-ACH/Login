...
<div class="row">
    <div class="col-sm-12">
        ...
        <table id="tablaIdentidadLoad" class="table">
            <!-- <br><h2>Mantenimiento de Parámetros</h2> -->
            <?php if (!$ocultarInsercion): ?>
            <button style="width: 20%;" class="btn btn-primary btn-agregar" data-toggle="modal" data-target="#modalNuevaIdentidad">
                ...
                $sql = "SELECT
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-warning" data-toggle="modal" data-target="#modalEditarIdentidad" onclick="cargarDatos('<?php echo $datos; ?>')">

...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-04-2024 a las 06:53:13
...
(242, '2024-04-16 22:08:23', 1, 'REGISTRAR', 'PACIENTE 1 HA SIDO REGISTRADO'),
(243, '2024-04-16 22:21:18', 1, 'REGISTRAR', 'PACIENTE 1 HA SIDO REGISTRADO'),
(244, '2024-04-16 22:21:38', 1, 'CREAR', 'SE HA CREADO EL EXPEDIENTE 1 AL PACIENTE 1'),
(245, '2024-04-16 22:23:52', 1, 'AGENDAR', 'CITA 11 FUE AGENDADA PARA EL 2024-04-19 A LAS 13:20 PARA EL PACIENTE 1'),
(246, '2024-04-16 22:24:56', 1, 'AGENDAR', 'CITA 12 FUE AGENDADA PARA EL 2024-04-19 A LAS 11:30 PARA EL PACIENTE 1'),
(247, '2024-04-16 22:25:00', 1, 'MODIFICADO', 'EL ESTADO DE LA CITA 12 HA SIDO MODIFICADO DE \"PENDIENTE\" A \"ESPERA\". '),
(248, '2024-04-16 22:25:04', 1, 'MODIFICADO', 'EL ESTADO DE LA CITA 11 HA SIDO MODIFICADO DE \"PENDIENTE\" A \"ESPERA\". '),
(249, '2024-04-16 22:25:39', 3, 'INICIO DE SESIÓN', 'TESTING INICIÓ SESIÓN'),
(250, '2024-04-16 22:25:47', 3, 'CIERRE DE SESIÓN', 'TESTING FINALIZÓ SESIÓN.'),
(251, '2024-04-16 22:26:16', 3, 'INICIO DE SESIÓN', 'TESTING INICIÓ SESIÓN'),
(252, '2024-04-16 22:29:16', 2, 'INICIO DE SESIÓN', 'FISIATRA INICIÓ SESIÓN'),
(253, '2024-04-16 22:30:06', 3, 'CIERRE DE SESIÓN', 'TESTING FINALIZÓ SESIÓN.'),
(254, '2024-04-16 22:33:13', 1, 'CANCELAR', 'CITA 11 FUE CANCELADA'),
(255, '2024-04-16 22:33:35', 1, 'AGENDAR', 'CITA 13 FUE AGENDADA PARA EL 2024-04-17 A LAS 16:33 PARA EL PACIENTE 1'),
(256, '2024-04-16 22:33:42', 1, 'MODIFICADO', 'EL ESTADO DE LA CITA 13 HA SIDO MODIFICADO DE \"PENDIENTE\" A \"ESPERA\". '),
(257, '2024-04-16 22:33:45', 1, 'CIERRE DE SESIÓN', 'ADMIN FINALIZÓ SESIÓN.'),
(258, '2024-04-16 22:33:54', 2, 'INICIO DE SESIÓN', 'FISIATRA INICIÓ SESIÓN');
...
(1, '0801199908831', 'PACIENTE PRUEBA', 'EL HATO', '1999-02-18', 1, 1, 'ESTUDIANTE', 1);
...
--
ALTER TABLE `tbl_cita_terapeutica`
  ADD CONSTRAINT `FK_TBL_ESPECIALISTA_TBL_CITA` FOREIGN KEY (`Id_Especialista`) REFERENCES `tbl_ms_usuario` (`Id_Usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_TBL_ESTADO_CITA_TBL_CITA` FOREIGN KEY (`Id_Estado_Cita`) REFERENCES `tbl_estado_cita` (`Id_Estado_Cita`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_TBL_EXPEDIENTE_TBL_CITA` FOREIGN KEY (`Id_Expediente`) REFERENCES `tbl_expediente` (`id_Expediente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_TBL_PACIENTE_TBL_CITA` FOREIGN KEY (`Id_Paciente`) REFERENCES `tbl_paciente` (`Id_Paciente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_TBL_TIPOCITA_TBL_CITA` FOREIGN KEY (`Id_Tipo_Cita`) REFERENCES `tbl_tipo_cita` (`Id_Tipo_Cita`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_TBL_USUARIO_TBL_CITA` FOREIGN KEY (`Id_Usuario`) REFERENCES `tbl_ms_usuario` (`Id_Usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
